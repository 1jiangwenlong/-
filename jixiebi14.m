...
clearvars -except fg0 fg1 fg2 xx0  xx1 xx2 W_1 W_2 S0 S1 S2 afa FG0 x00 FG1 x11 FG2 x22 W1 W2 xxx1 xxx2 E1 n1 N1
close all
%% 机械臂参数
...
%% 计算正常和故障系统状态 
   ...
   xxg1 = xg';
   % [FGz,xz] = sys(x0,W1,W2,E1,n1,N1,N,h,beta1,beta2,Kv,K,0,0);
   %xxx1 = [xxz;xxg1];
...
%    end
   ...
   figure
   plot(xxxx1(:,3),xxxx1(:,4),'-b')
   hold on
   plot(xxxx2(:,3),xxxx2(:,4),'-r')
%    figure 
