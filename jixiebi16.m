...
%% 计算正常和故障系统状态 
   ...
   x22 = x';
   [FG3,x] = sys(x0,W1,W2,E1,n1,N1,N,h,beta1,beta2,Kv,K,3);
   x33 = x';
   [FG4,x] = sys(x0,W1,W2,E1,n1,N1,N,h,beta1,beta2,Kv,K,4);
   x44 = x';
%    [FG5,x] = sys(x0,W1,W2,E1,n1,N1,N,h,beta1,beta2,Kv,K,5);
%    x55 = x';
%    [FG6,x] = sys(x0,W1,W2,E1,n1,N1,N,h,beta1,beta2,Kv,K,6);
%    x66 = x';
